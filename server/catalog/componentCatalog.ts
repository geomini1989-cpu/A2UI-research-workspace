...
export const COMPONENT_CATALOG: CatalogComponentSpec[] = [
  ...
  },
  {
    ...
    props: { columns: 'array<{key,label}>', rows: 'array<object>', rowAction: 'semanticAction? (requires context.interactionMode=research)', weight: 'number?' },
  ...
  },
  {
    ...
    props: { title: 'string', value: 'string', change: 'string?', description: 'short string?', detail: 'object? {title?,summary?,keyPoints?}; inline addition from current payload', action: 'semanticAction? (research follow-up requires context.interactionMode=research)', weight: 'number?' },
  ...
  },
  {
    ...
    props: {
      ...
      left: 'string?',
      right: 'string?',
      rows: 'array<{metric,left,right}>', rowAction: 'semanticAction? (requires context.interactionMode=research)',
  ...
  },
  {
    ...
    props: {
      ...
      change: 'string?',
      marketCap: 'string?',
      action: 'semanticAction? (requires context.interactionMode=research)',
      weight: 'number?',
    },
    required: ['company'],
  },
  ...
  },
  {
    ...
    props: { level: 'string (HIGH|MEDIUM|LOW)', label: 'string?', description: 'string?', action: 'semanticAction? (requires context.interactionMode=research)', weight: 'number?' },
    required: ['level'],
  },
  {
    name: 'InsightList',
