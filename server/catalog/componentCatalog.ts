...
export const COMPONENT_CATALOG: CatalogComponentSpec[] = [
  ...
  },
  {
    ...
    label: 'Metric Card',
    category: 'business',
    description: 'A compact highlighted business metric. Prefer a short inline detail for small additions instead of generating another surface.',
    props: { title: 'string', value: 'string', change: 'string?', description: 'short string?', detail: 'object? {title?,summary?,keyPoints?,data?,targetChartId?}; toggles compact detail inside the card', action: 'semanticAction?', weight: 'number?' },
